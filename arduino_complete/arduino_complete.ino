...
#include "Wire.h"
#endif
#define ImuPin 2 // TODO
/////////


////////// SERIAL MESSAGE TO ROS
...
int gyro[3];       // [wx,wy,wz]           angular velocities
...
void imu_values(){
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 4096) {
    ...
    arduino_msg.sensor_data.lw = -1;//TODO
    arduino_msg.sensor_data.rw = -1;//TODO
    arduino_msg.sensor_data.start = 90;// TODO
...
void setup()
{
  ...
  if (devStatus == 0) {
    ...
    Serial.println(F("Enabling interrupt detection (Arduino external interrupt ImuPin)..."));
  ...
  pinMode(3, INPUT);
  pinMode(2, INPUT);
  digitalWrite(3, HIGH);// TO Low--> enable interrupt
  digitalWrite(2, HIGH);
